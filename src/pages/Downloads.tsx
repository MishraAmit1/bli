            ...
            >
              {featuredDownloads.map((item, index) => (
                ...
                >
                  ...
                  <span className="inline-block px-1.5 sm:px-2 py-0.5 sm:py-1 text-[10px] sm:text-[11px] text-[#113C6A] bg-[#113C6A]/10 font-medium mb-2 sm:mb-3">
                    {item.category}
                  </span>
          ...
          {filteredDownloads.length === 0 ? (
            ...
            >
              {regularDownloads.map((item, index) => (
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center gap-3 sm:gap-4 p-4 sm:p-5 lg:p-6">
                    <div className="flex items-start gap-3 sm:gap-4 flex-1">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#113C6A]/10 flex items-center justify-center flex-shrink-0">
                        <item.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#113C6A]" />
                      </div>

                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                          <h3 className="text-sm sm:text-base font-bold text-[#1a1a1a] group-hover:text-[#113C6A] transition-colors">
                            {item.title}
                          </h3>
                          <span className="px-1.5 sm:px-2 py-0.5 text-[9px] sm:text-[10px] text-[#113C6A] bg-[#113C6A]/10 font-medium">
                            {item.category}
                          </span>
                        </div>
                        <p className="text-xs sm:text-sm text-gray-500 font-light line-clamp-1 mb-1.5 sm:mb-2">
                          {item.description}
                        </p>
                    ...
                    <button className="group/btn inline-flex items-center justify-center gap-1.5 sm:gap-2 border border-[#1a1a1a] px-4 sm:px-5 py-2 sm:py-2.5 hover:bg-[#1a1a1a] hover:text-white transition-all duration-300 w-full md:w-auto">
                      <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                      <span className="font-medium text-xs sm:text-sm">
                        Download
                      </span>
      ...
      <section className="py-12 sm:py-14 lg:py-16 px-5 sm:px-8 lg:px-12 bg-gradient-to-b from-white to-[#113C6A]">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            >
              <span className="font-medium text-xs sm:text-sm">Get Quote</span>
