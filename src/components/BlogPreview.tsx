...
const BlogPreview = () => {
  ...
  return (
    <section id="blog" className="py-12 md:py-24 px-4 md:px-12 bg-[#]">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#113C6A]">Latest Updates</h2>
          ...
          <Link to="/blog" className="mt-4 md:mt-0">
            <Button variant="outline" className="group border-[#185EAA] text-[#113C6A] hover:bg-[#113C6A] hover:text-[#FFFDF7] hover:border-[#113C6A]">
              View All Posts
          ...
          <div className="mt-4 flex justify-center md:hidden">
            <div className="flex gap-1">
              {[0, 1, 2].map((i) => (
                <div
                  key={i}
                  className={`h-1.5 rounded-full ${i === 0 ? 'w-6 bg-[#FF7729]' : 'w-2 bg-[#185EAA]/30'}`}
                />
              ))}
            </div>
          </div>
