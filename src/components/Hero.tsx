  ...
  return (
    <>
      ...
      <div className="relative w-full">
        {/* ── HERO — mobile height chhoti ki ── */}
        <div className="relative w-full h-[50vh] min-h-[400px] sm:h-[80vh] lg:h-[85vh] max-h-[800px] overflow-hidden bg-black">
          <div className="absolute inset-0 z-0">
            {!introDone ? (
              <>
                {!isVideoLoaded && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 border-2 border-white/20 border-t-[#FF7300] rounded-full animate-spin" />
                  </div>
                )}
                {/* ✅ object-cover on all screens — no black bars */}
                <video
                  ref={introVideoRef}
                  autoPlay
                  muted
          ...
          {/* ── Bottom Content ── */}
          {introDone && (
            <div className="absolute bottom-0 left-0 right-0 z-10 pt-24 sm:pt-32 lg:pt-44 pb-8 sm:pb-10 lg:pb-14 bg-gradient-to-b from-transparent to-black/85 pointer-events-none">
              <div className="max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-12">
                <div className="relative pb-6 sm:pb-8 lg:pb-10 after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-gradient-to-r after:from-white/30 after:to-transparent">
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-6 items-end">
                    <div className="md:col-span-7 pointer-events-auto">
                      <motion.h1
                        className="uppercase text-[24px] sm:text-[32px] md:text-[40px] lg:text-[54px] font-bold text-white leading-[1.15] sm:leading-[1.12] lg:leading-[1.1] tracking-[0.04em] sm:tracking-[0.03em]"
                      ...
                      <motion.p
                        className="text-white/70 mt-4 sm:mt-5 text-sm sm:text-[15px] md:text-base lg:text-lg max-w-md leading-relaxed font-light"
                    ...
                    <div className="md:col-span-5 flex md:justify-end items-end pointer-events-auto">
                      ...
                      >
                        <Link to="/contact">
                          <button className="group inline-flex items-center gap-2 sm:gap-2.5 rounded-full bg-[#FF7300] hover:bg-[#e56800] active:bg-[#cc5d00] text-white font-semibold text-sm sm:text-[15px] pl-5 sm:pl-6 pr-3 sm:pr-3.5 py-2.5 sm:py-3 transition-colors duration-300">
        ...
        >
          <div className="max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-12">
            ...
            <div className="text-center mb-10 sm:mb-12 lg:mb-14">
              ...
              <h2 className="font-bold uppercase tracking-normal mb-3 text-[24px] leading-[30px] sm:text-[36px] sm:leading-[42px] lg:text-[52px] lg:leading-[60px] text-black">
            ...
            <div className="relative">
              ...
              <div
                className="hidden lg:block absolute top-0 left-0 right-0 pointer-events-none"
                style={{ height: "60px" }}
              >
                <div
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-10">
                {stats.map((stat, i) => (
                  <motion.div
                    key={i}
                    className="flex flex-col items-center text-center pt-6 sm:pt-8 lg:pt-[60px] pb-4 sm:pb-6"
                  ...
                  >
                    {/* Icon Circle */}
                    <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-[72px] lg:h-[72px] rounded-full bg-[#113C6A] flex items-center justify-center mb-4 sm:mb-5 lg:mb-6">
                      <stat.Icon />
                    </div>

                    {/* Number */}
                    <div className="font-bold leading-none tracking-tight text-[28px] sm:text-[36px] lg:text-[52px] lg:leading-[60px] text-black">
                      {stat.displayPrefix ? (
                        <motion.span
                          initial={{ opacity: 0 }}
                          animate={
                    ...
                    {/* Label */}
                    <p className="font-light mt-1.5 sm:mt-2 lg:mt-2.5 text-sm sm:text-base lg:text-[20px] lg:leading-[29px] text-[#1C1825]">
                      {stat.label}
                    </p>
                  </motion.div>
                ))}
